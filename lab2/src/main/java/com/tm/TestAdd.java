...
public class TestAdd {
    ...
    @Benchmark
    public boolean add_before(RepositoryState repoState, BeforeState before) {
        return repoState.orders.add(before.order);
    }

    @Benchmark
    public boolean add_existing(RepositoryState repoState, ExistingState existing) {
        return repoState.orders.add(existing.order);
    }

    @Benchmark
    public boolean add_after(RepositoryState repoState, AfterState after) {
